...
define_palette! {
    ...
    colors {
        ...
        BLACK = crate::color::Color::hex(0x1b1d2b),
        ...
        GIT_ADD = crate::color::Color::hex(0xb8db87),
        GIT_CHANGE = crate::color::Color::hex(0x7ca1f2),
        GIT_DELETE = crate::color::Color::hex(0xe26a75),
