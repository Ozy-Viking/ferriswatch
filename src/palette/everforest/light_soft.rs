...
define_palette! {
    ...
    colors {
        ...
        BG_0 = crate::color::Color::hex(0xf3ead3),
        BG_1 = crate::color::Color::hex(0xeae4ca),
        BG_2 = crate::color::Color::hex(0xe5dfc5),
        BG_3 = crate::color::Color::hex(0xddd8be),
        BG_4 = crate::color::Color::hex(0xd8d3ba),
        BG_5 = crate::color::Color::hex(0xb9c0ab),
        BG_VISUAL = crate::color::Color::hex(0xe1e4bd),
        BG_RED = crate::color::Color::hex(0xfadbd0),
        BG_YELLOW = crate::color::Color::hex(0xf1e4c5),
        BG_GREEN = crate::color::Color::hex(0xe5e6c5),
        BG_BLUE = crate::color::Color::hex(0xe1e7dd),
        BG_PURPLE = crate::color::Color::hex(0xf1ddd4),
