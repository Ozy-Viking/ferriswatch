...
define_palette! {
    ...
    colors {
        ...
        BG_0 = crate::color::Color::hex(0xfdf6e3),
        BG_1 = crate::color::Color::hex(0xf4f0d9),
        BG_2 = crate::color::Color::hex(0xefebd4),
        BG_3 = crate::color::Color::hex(0xe6e2cc),
        BG_4 = crate::color::Color::hex(0xe0dcc7),
        BG_5 = crate::color::Color::hex(0xbdc3af),
        BG_VISUAL = crate::color::Color::hex(0xeaedc8),
        BG_RED = crate::color::Color::hex(0xfde3da),
        BG_YELLOW = crate::color::Color::hex(0xfaedcd),
        BG_GREEN = crate::color::Color::hex(0xf0f1d2),
        BG_BLUE = crate::color::Color::hex(0xe9f0e9),
        BG_PURPLE = crate::color::Color::hex(0xfae8e2),
