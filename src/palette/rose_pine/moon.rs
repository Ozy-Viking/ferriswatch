...
define_palette! {
    ...
    colors {
        ...
        BASE = crate::color::Color::hex(0x232136),
        SURFACE = crate::color::Color::hex(0x2a273f),
        OVERLAY = crate::color::Color::hex(0x393552),
        ...
        ROSE = crate::color::Color::hex(0xea9a97),
        PINE = crate::color::Color::hex(0x3e8fb0),
        FOAM = crate::color::Color::hex(0x9ccfd8),
        IRIS = crate::color::Color::hex(0xc4a7e7),
        LEAF = crate::color::Color::hex(0x95b1ac),
        HIGHLIGHT_LOW = crate::color::Color::hex(0x2a283e),
        HIGHLIGHT_MED = crate::color::Color::hex(0x44415a),
        HIGHLIGHT_HIGH = crate::color::Color::hex(0x56526e),
    }
    accents {
        Love = LOVE => ("love", "Love"),
        Gold = GOLD => ("gold", "Gold"),
