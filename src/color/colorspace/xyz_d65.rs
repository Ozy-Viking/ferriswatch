...
/// CIE XYZ tristimulus coordinates relative to a D65 reference white.
///
...
///
/// `Display` writes CSS `color(xyz-d65...)` with three decimal places by default;
