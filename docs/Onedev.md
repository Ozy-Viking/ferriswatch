...
OneDev registry setup and collaboration sync for Ferriswatch. This page is kept
in the source repository and excluded from the GitHub wiki.
...
`tools/sync_collaboration.py` links `rust/ferriswatch` on OneDev with
